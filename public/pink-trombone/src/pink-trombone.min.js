!(function (t) {
  ...
  function (t, e, n) {
      ...
      null == window.AudioContext.prototype.createConstantSource &&
        (window.AudioContext.prototype.createConstantSource = function () {
          ...
          return (
            ...
            t._targetTime,
            t._duration,
            (t.minValue = -3.402820018375656e38),
            (t.maxValue = 3.402820018375656e38),
            (t._clamp = function (t) {
        ...
        (n = [
          {
            ...
            value: function (t, e, n, i) {
              ...
              (_ *= p),
                (_ *= o),
                (_ *= o),
                (_ *= 1 - Math.sqrt(Math.max(h, 0))),
                (_ *= 0.02 * this.noise.simplex1(1.99 * i) + 0.2);
        ...
        (n = [
          {
            ...
            value: function (t, e, n, i) {
              ...
              var o = e / n,
                ...
                s = 0;
              return (
                (s += this._processLips(t, o, r)),
                (s += this._processNose(t, o, r)),
                isNaN(s) && this.reset(),
                s
              );
            },
              ...
              this.nose.amplitude[0] < 0.05 &&
                (this.transients.obstruction.last > -1 &&
                  ...
                  this.transients.push(
                    new m(this.transients.obstruction.new, t)
                  ),
        ...
        (n = [
          {
            ...
            value: function (t, e, n, i) {
              ...
              return (
                (t.glottis = a),
                (s += (r = this.tract).process.apply(r, arguments)),
                (e += 0.5),
      ...
      var V = (function (t) {
        function e(t) {
          ...
          return (
            ...
            (i = this),
            (o = P(e).call(this, t, "pink-trombone-worklet-processor")),
            (n =
              !o || ("object" !== w(o) && "function" != typeof o) ? C(i) : o),
            A(C(n)),
            ...
            value: function (t) {
              return void 0 !== t.audioWorklet
                ? t.audioWorklet.addModule(
                    "/pink-trombone/src/pink-trombone-worklet-processor.min.js" // FIX
                  )
    ...
    var W = (function () {
      function t() {
        ...
        !(function (t, e) {
          ...
          (this._tractUI = new F()),
          (this._glottisUI = new L()),
          (this._buttonsUI = new D()),
          (this._container = document.createElement("div")),
    ...
    var Q = (function (t) {
      function e() {
        ...
        !(function (t, e) {
          ...
          ((t = z(this, J(e).call(this)))._animationFrameObservers = []),
        ...
        (i = [
          {
            ...
            value: function () {
              null == this.UI &&
                ((this.UI = new W()), this.appendChild(this.UI.node)),
                this.UI.show();
            },
          },
          {
    ...
    document.createElement("pink-trombone").constructor == HTMLElement &&
      window.customElements.define("pink-trombone", Q);
    e.default = Q;
  },
]);
